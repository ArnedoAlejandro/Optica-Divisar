...
const Testimonials = () => {
  const testimonial = [
    {
      nombre: "Maria Fernanda D.",
      testimonio:
        "¡Increíble experiencia en OptiVisión! La atención personalizada y la calidad de mis lentes superaron mis expectativas. ¡Totalmente recomendado!",
      foto: "",
    },
    {
      nombre: "Martin G.",
      testimonio:
        "Optica Divisar me sorprendió gratamente. Sus profesionales me ayudaron a encontrar las gafas perfectas. ¡Estoy encantado con mi compra ",
      foto: " ",
    },
    {
      nombre: "Lucua R. ",
      testimonio:
        "Excelente servicio en Optica Divisar. Encontré los anteojos ideales y el precio fue muy accesible. ¡Muy contenta con mi elección",
      foto: " ",
    },
    {
      nombre: "Juan p. ",
      testimonio:
        "No podría estar más feliz con mi compra en Óptica Divisar! Mis lentes son de alta calidad y el equipo fue muy amable y servicial. ¡Gracias! ",
      foto: " ",
    },
    {
      nombre: "Carlos S. ",
      testimonio:
        "Óptica Divisar me brindó una experiencia excepcional. Desde la selección de los anteojos hasta el ajuste final, todo fue perfecto. ¡Muy recomendable! ",
      foto: " ",
    },
    {
      nombre: "Diego M. ",
      testimonio:
        "Optica Divisar es lo mejor que me ha pasado! Sus productos son de primera calidad y el servicio al cliente es insuperable. ¡Definitivamente volveré! ",
      foto: " ",
    },
  ];
        ...
        <div className="overflow-hidden bg-white rounded-lg shadow-lg shadow-slate-400 text-slate-500 ">
          <div className="relative p-6 max-md:p-3">
            <figure className="relative z-10">
              ...
              <figcaption className="flex items-center gap-4 p-6 pt-2 text-sm text-yellow-500 ">
                <img
